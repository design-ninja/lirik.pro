...
translationKey: 'os'
title: 'OS'
description: 'Project and task management system with kanban board and calendar'
tags: ['Web app', 'UI/UX', 'Design system', 'React', 'Figma']
seo:
  title: 'OS — project management system'
  description: 'Designing and developing a project management interface with kanban board, calendar, and radix-ui based design system.'
  image:
    src: '../../assets/os/1.png'
    alt: 'OS — case study'
...
![Design tokens in Figma](../../assets/os/7.png)
...
![Mobile version](../../assets/os/8.png)
